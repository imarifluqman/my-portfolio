...
export default function Contact() {
    return (
        <>
            {/* <h2 className="text-3xl my-4 text-center">Contact <span className="font-bold">Me</span> </h2> */}
            <div className="lg:container mx-auto lg:w-full p-2 my-8 lg:flex justify-between items-center " id="contact">
                ...
                <div className="lg:w-1/2 w-full">
                    ...
                    <div className="w-full lg:w-[90%] mx-auto flex space-x-4 my-4">
                        <button className="bg-black text-white border hover:border-black hover:bg-white hover:text-black text-[12px] lg:text-[16px] px-4 py-2">Get in Touch</button>
